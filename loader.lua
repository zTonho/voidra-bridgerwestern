-- voidra public loader placeholder
-- Replace this file with your obfuscated build before uploading to GitHub.
-- Source file: src/loader.lua

error("[voidra] Public loader was not built yet. Obfuscate src/loader.lua and replace loader.lua with the obfuscated output.")
local Repo = "https://raw.githubusercontent.com/zTonho/voidra/refs/heads/main/"
